    ...
    <div class="home-atas">
        ...
        <div class="pendahuluan">
            <div class="content">
                <span>Welcome</span>
                <h3>Go Dessert</h3>
                <p>Dessert kekinian dan harga kantong pelajar</p>
                <p>buru pesan dan dapatkan diskon</p>
            </div>
            <div class="image">
                <img src="<?= base_url('assets/img/'); ?>cheff.png" alt="">
            </div>
        </div>
</section>
<!-- home end -->
...
<form action="" id="search-form">
    <input type="search" placeholder="Cari ..." name="" id="search-box">
...
<section class="about" id="about">
    ...
    <h1 class="heading"> kenapa Website ini? </h1>

    <div class="row">

        <div class="image">
            <img src="<?= base_url('assets/img/'); ?>oip.png" alt="">
        </div>

        <div class="content">
            <h3>Gossert</h3>
            <p>Gossert adalah sebuah website yang menyajikan berbagai makanan penutup kekinian dengan harga yang pas untuk kantong pelajar.</p>
            <p>Gossert merupakan website yang memudahkan anda untuk memesan secara online dengan pembayaran yang mudah dan gratis ongkos kirim.</p>
