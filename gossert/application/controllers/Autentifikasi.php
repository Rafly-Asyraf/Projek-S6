...
class Autentifikasi extends CI_Controller
{
    ...
    private function _login()
    {
        ...
        if ($user) {
            // Verifikasi password
            if (password_verify($password, $user['password'])) { // Gunakan password_verify() untuk memverifikasi password
                // Password cocok, set data pengguna ke dalam session
            ...
            // User tidak ditemukan berdasarkan email
